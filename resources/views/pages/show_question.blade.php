...
<div style="padding: 5px; margin-top:20px"> <span class="category"> {{ $question->category}}</span>
...
<div class="text-left mark"><a href="/trid=fedits/{{$question->id}}">Edit</a>
...
<div style="margin-top:10px"><a href="/create-answer/{{$question->id}}" class="btn btn-primary"> Provide Answer</a></div>
...
<h3>No Answer for this question </h3>
@endif
